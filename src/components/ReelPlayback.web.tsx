...
export function ReelPlayback({uri,active}:{uri:string;active:boolean}) {
 ...
 return <div style={{position:'absolute',inset:0}}>
  <video ref={video} src={uri} loop muted={muted} playsInline preload={active?'auto':'none'} onError={()=>setError(true)} style={{width:'100%',height:'100%',objectFit:'cover',pointerEvents:'none'}}/>
