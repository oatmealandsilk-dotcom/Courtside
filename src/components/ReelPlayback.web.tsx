...
export function ReelPlayback({uri,poster,active,preload=false,onDoubleTap}:{uri:string;poster?:string;active:boolean;preload?:boolean;onDoubleTap?:()=>void}) {
 ...
 return <div style={{position:'absolute',inset:0}}>
  ...
  <button aria-label={paused?'Play reel':'Pause reel'} onClick={()=>{
