          ...
          <VerticalPager ref={pager} key={visit} initialIndex={active} onIndex={setActive}>
            {feed.map((item, index) => {
              ...
              if (item.type === 'question') {
                ...
                return (
                  <View key={item.question.id} style={[styles.article, styles.threadArticle, !phone && styles.articleDesktop]}>
...
const styleDefinitions = StyleSheet.create({
  ...
  // On a computer a thread keeps a reading column in the middle of the window, like Reddit or Threads.
  articleDesktop: { maxWidth: 680, width: '100%', alignSelf: 'center' },
