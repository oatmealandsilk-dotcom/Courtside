...
export default function Profile() {
 ...
 return <Screen title="Profile" subtitle={`@${user.handle}`} right={<View style={styles.headerActions}>
   ...
   <View style={styles.identity}>
     ...
     <View style={styles.buttons}><View style={{ flex: 1 }}><Button label="Edit Profile" variant="secondary" onPress={() => router.push('/edit-profile')} full/></View><View style={{ flex: 1 }}><Button label="Share" variant="secondary" onPress={share} full/></View><Pressable accessibilityRole="link" accessibilityLabel="Settings" onPress={() => router.push('/settings')} style={styles.settings}><Ionicons name="settings-outline" size={23} color={colors.textMuted}/></Pressable></View>
